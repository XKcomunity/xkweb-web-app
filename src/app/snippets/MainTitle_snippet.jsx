		...
		<>
			<main className={styles.main_snippet}>
				<h1 className={styles.h1}>
					Explora Por <span className={styles.h1_span}>Temas</span>
				</h1>
				<p className={styles.headings_snippets_text}>
					Esta sección está organizada por temas, al seleccionar uno en
